...
public class HeroDaoDB implements HeroDao {
    ...
    private List<Superpower> getSuperpowersForHero(int id) {
        ...
        return jdbc.query(SELECT_SUPERPOWERS_FOR_HERO, new SuperpowerDaoDB.SuperpowerMapper(), id);
    }
    
    private List<Sighting> getSightingsForHero(int id) {
        final String SELECT_SIGHTINGS_FOR_HERO = "SELECT * FROM Sighting WHERE HeroId = ?";
        List<Sighting> sighthings = jdbc.query(SELECT_SIGHTINGS_FOR_HERO, new SightingDaoDB.SightingMapper(), id);
